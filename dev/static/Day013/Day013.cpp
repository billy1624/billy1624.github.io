...
public:
    Human(string name, string dateOfBirth, bool alive, Human* father, Human* mother)
     : Animal(name, dateOfBirth, alive) {  // Here I use C++ initializer list, see https://www.geeksforgeeks.org/when-do-we-use-initializer-list-in-c/
        this->father = father;
        this->mother = mother;
    }
    void print(string pre="") {
...
/**
 * Want to learn more about inheritance in C++,
 * please see https://www.geeksforgeeks.org/inheritance-in-c/
